...
public final class Effects {
    ...
    private static MapleStatEffect ofEffect(int id, boolean overTime, WzElement<?> level, boolean skill) {
        ...
        effect.setMp((short) Elements.findInt(level, "mp"));
        effect.setMpCon((short) Elements.findInt(level, "mpCon"));
        effect.setHpCon((short) Elements.findInt(level, "hpCon"));
        ...
        effect.setMhpR((byte) Elements.findInt(level, "mhpR"));
        effect.setMmpR((byte) Elements.findInt(level, "mmpR"));
        ...
        effect.setMastery((byte) Elements.findInt(level, "mastery"));
        effect.setWatk((short) Elements.findInt(level, "pad"));
        effect.setWdef((short) Elements.findInt(level, "pdd"));
        effect.setMatk((short) Elements.findInt(level, "mad"));
        effect.setMdef((short) Elements.findInt(level, "mdd"));
        effect.setEhp((short) Elements.findInt(level, "emhp"));
        effect.setEmp((short) Elements.findInt(level, "emmp"));
        effect.setEwatk((short) Elements.findInt(level, "epad"));
        effect.setEwdef((short) Elements.findInt(level, "epdd"));
        effect.setEmdef((short) Elements.findInt(level, "emdd"));
        effect.setAcc((short) Elements.findInt(level, "acc"));
        effect.setAvoid((short) Elements.findInt(level, "eva"));
        effect.setSpeed((short) Elements.findInt(level, "speed"));
        effect.setJump((short) Elements.findInt(level, "jump"));
        ...
        effect.setDamage((short) Elements.findInt(level, "damage", 100));
        effect.setAttackCount((byte) Elements.findInt(level, "attackCount", 1));
        effect.setBulletCount((byte) Elements.findInt(level, "bulletCount", 1));
